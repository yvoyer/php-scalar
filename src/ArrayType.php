...
final class ArrayType implements Type
{
    ...
    {
        return TypedString::asArray($this->implode(',')->toString())->toString();
    }

    public function implode(string $delimiter): StringType
    {
        return StringType::fromString(\implode($delimiter, $this->values));
    }

    public function map(\Closure $closure): ArrayType
    {
        return ArrayType::fromArray(\array_map($closure, $this->values));
    }
    ...
    public function pop(): ArrayType
    {
        $array = $this->values;
        \array_pop($array);
        return ArrayType::fromArray($array);
    }
    ...
    {
        return ArrayType::fromArray(\array_values($this->values));
    }
